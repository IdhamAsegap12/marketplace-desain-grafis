...
<div class="container mt-m">
    <h1 class="border-bottom py-3">{{ $category->nama }}</h1>

    <div class="row">
        @foreach ($category->producks as $produck)
          ...
          <div class="col-md-4 mt-2 d-flex justify-content-center">
                <div class="overflow-hidden d-flex position-relative" style="height: 22rem; width: 25rem">
                    ...
                    @if ($produck->image)
                        <img src="{{ asset('storage/'. $produck->image ) }}" class=" style="object-fit: cover; height: 100%; width: 100%;" " alt="..."> 
                    @else
